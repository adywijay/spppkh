...
<head>
    ...
    <link href="<?php echo base_url();?>template/js/plugins/stepper/css/mstepper.min.css" type="text/css" rel="stylesheet" media="screen,projection">
</head>
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color fixed   light-blue accent-2" role="navigation">
                <div class="nav-wrapper container">
                    <a href="<?php echo site_url('surveyer');?>" class="center"><img class="white-text hoverable" style="max-height:100% !important; margin-left:15px !important;" src="<?php echo base_url()?>template/images/logo/kemsos.png"></a>
                    <ul class="right">
                        <li>
                            <a href="<?php echo base_url('logout');?>" onclick="return confirm('Yakin ingin Keluar dari Sistem &nbsp?')" class="btn-floating gradient-45deg-light-blue-cyan white-text  btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Keluar dari sistem"><i class="material-icons">exit_to_app</i></a>
