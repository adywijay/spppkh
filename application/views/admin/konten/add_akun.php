                ...
                <?php echo form_open_multipart('admin/tambah_akun'); ?>
                    <div class="row">
                        ...
                        <div class="input-field col s12">
                            ...
                            <input name="nama" type="text" placeholder="&nbsp;" class="validate"/>
                        </div>
                        <div class="input-field col s12">
                            <label for="username"class="red-text">Username *</label>
                            <input type="text" name="username" placeholder="&nbsp;" class="validate"/>
                        </div>
                        <?php
                        $a = date("iszA");
                        ?>
                        ...
                        <div class="input-field col s12">
                            ...
                            <input type="text" name="token" placeholder="&nbsp;" class="validate"/>
                        </div>
                        <div class="input-field col s12">
                        ...
                        <div class="input-field col s12">
                            ...
                            <input type="text" name="no_telp" placeholder="&nbsp;" class="validate" maxlength="12"/>
                        </div>
                        <div class="input-field col s12">
                        ...
                        <div class="col s12">
                            ...
                            <select class="error browser-default validate" name="id_akses" placeholder="&nbsp;"/>
                                <option class="center" value="" disabled selected>--Pilih--</option>
                                <?php foreach ($admin as $a) {?>
                                <option value="<?php echo $a->id_akses; ?>"><?php echo $a->nama_akses; ?></option>
                                <?php }?>
                            </select>
                        </div>
