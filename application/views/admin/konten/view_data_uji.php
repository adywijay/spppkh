<section id="content">
    <div class="container">
        <div class="row">
            <div class="col s12">
                <?php echo form_open_multipart('admin/import_dtuji'); ?>
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        ...
                        &nbsp;&nbsp;&nbsp;<a class="btn tooltipped waves-effect btn-floating teal accent-4 center" data-position="bottom" data-delay="50" data-tooltip="Uji Rule" href="<?php echo base_url('keputusan'); ?>"><i class="mdi mdi-file-tree"></i></a>
                        &nbsp;&nbsp;&nbsp;<a class="btn tooltipped waves-effect btn-floating red center" data-position="right" data-delay="50" data-tooltip="Reset Data" onclick="return confirm('Yakin ingin mereset data&nbsp;?')" href="<?php echo base_url('admin/reset_data_uji'); ?>"><i class="mdi mdi-history"></i></a>
                    </div>
                </div>
            </div>
            <?php echo form_close(); ?>
