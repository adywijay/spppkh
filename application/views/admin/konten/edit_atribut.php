    ...
    <div class="row">
        ...
        <div class="col s12 m12 l6">
            <ul id="task-card" class="collection with-header" style="border-radius:9px;">
                ...
                <?php echo form_open_multipart('admin/action_edit'); ?>
                <div class="row">
                    <br/>
                    <div class="input-field col s12">
                        <label class="red-text">ID *</label>
                        <input name="id" type="text" placeholder="&nbsp;" value="<?php echo $admin['id'];?>" disabled/>
                    </div>
                    <div class="input-field col s12">
                        <label class="red-text">Atribut *</label>
                        <input name="atribut" type="text" placeholder="&nbsp;" value="<?php echo $admin['atribut'];?>"/>
                    </div>
                    <div class="input-field col s12">
                        <label class="red-text">Nilai Atribut *</label>
                        <input name="nilai_atribut" type="text" placeholder="&nbsp;" value="<?php echo $admin['nilai_atribut'];?>"/>
                    </div>
                    <div class="input-field col s12">
                        <label class="red-text">Keterangan Nilai *</label>
                        <input name="ket_nilai" type="text" placeholder="&nbsp;" value="<?php echo $admin['ket_nilai'];?>"/>
                    </div>
                    <div class="row">
                        <div class="col s12 m6 l3">
                            <label class="red-text">Atribut Aktif...? *</label>
                            <p>
                                <input type="radio" id="y" name="aktif" value="y" <?php echo $admin['aktif'];?>/>
                                <label for="y">Ya</label>
                            </p>
                            <p>
                                <input type="radio" id="t" name="aktif" value="t" <?php echo $admin['aktif'];?>/>
                        ...
                        <div class="col s12 m6 l3">
                            ...
                            <p>
                                <input type="radio" id="label" name="status" value="label" <?php echo $admin['status'];?> />
                                <label for="label">Label</label>
                            </p>
                            <p>
                                <input type="radio" id="non_label" name="status" value="non_label" checked <?php echo $admin['status'];?>/>
