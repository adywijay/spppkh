...
<section id="content">
    <div class="container">
        <div class="row">
            <?php echo form_open_multipart('cadangan_operator'); ?>
            <div class="row">
                ...
                <div class="input-field col s12 m12 l3 center">
                    <button class="btn waves-effect gradient-45deg-light-blue-cyan" type="submit" name="submit" style="margin-top: 10px !important;">Tampil</button>  
                </div>
        ...
        <div class="col s12">
            <div id="table-datatables">
                <table id="data-table-simple" class="centered display" cellspacing="0">
                    ...
                    <span class="mdi mdi-cog-counterclockwise" style="margin-left:0px !important;">Total Data :&nbsp;&nbsp;&nbsp;<b class="red-text"><?php $this->db->where('tahun', $this->input->post('tahun'));$this->db->where('keputusan_hasil','TIDAK');echo $this->db->get('tbl_hasil_prediksi')->num_rows(); ?></b></span> 
                    <tr>
                        <th>ID</th>           
                        <th>Nama</th> 
                        <th>Desa</th> 
