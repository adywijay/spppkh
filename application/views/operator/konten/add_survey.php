                                    ...
                                    <div class="col s12">
                                        <div class="row">
                                            <div class="col s6">
                                                ...
                                                <p>
                                                    <input name="sta_lahan" type="radio" id="TN" name="TN" />
                                                    <label for="TN">Tanah Negara</label>
                                                </p>
                                                <p>
                                                    <input name="sta_lahan" type="radio" id="LN" name="LN" />
                                            ...
                                            <div class="col s6">
                                                ...
                                                <p>
                                                    <input name="sta_bangunan" type="radio" id="BSA" name="BSA" />
                                                    <label for="BSA">Bebas Sewa</label>
                                                </p>
                                                <p>
                                                    <input name="sta_bangunan" type="radio" id="DNS" name="DNS" />
                                                    <label for="DNS">Dinas </label>
                                                </p>
                                                <p>
                                                    <input name="sta_bangunan" type="radio" id="LN1" name="LN" />
                                        ...
                                        <div class="row">
                                            <div class="col s6">
                                                ...
                                                <p>
                                                    <input name="jns_lantai" type="radio" id="PVPI" name="PVPI" />
                                                    <label for="PVPI">Parket Vinil Permadani</label>
                                                </p>
                                                <p>
                                                    <input name="jns_lantai" type="radio" id="UTT" name="UTT" />
                                                    <label for="UTT">Ubin / Tegel / Teraso </label>
                                                </p>
                                                <p>
                                                    <input name="jns_lantai" type="radio" id="KPKT" name="KPKT" />
                                            ...
                                            <div class="col s6">
                                                ...
                                                <p>
                                                    <input name="jns_dinding" type="radio" id="KYU" name="KYU" />
                                                    <label for="KYU">Kayu</label>
                                                </p>
                                                <p>
                                                    <input name="jns_dinding" type="radio" id="ABU" name="ABU" />
                                                    <label for="ABU">Anyaman Bambu</label>
                                                </p>
                                                <p>
                                                    <input name="jns_dinding" type="radio" id="BKYU" name="BKYU" />
                                                    <label for="BKYU">Batang Kayu</label>
                                                </p>
                                                <p>
                                                    <input name="jns_dinding" type="radio" id="BBU" name="BBU" />
                                                    <label for="BBU">Bambu</label>
                                                </p>
                                                <p>
                                                    <input name="jns_dinding" type="radio" id="LN2" name="LN" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col s6">
                                                ...
                                                <p>
                                                    <input name="smb_air_minum" type="radio" id="SNG" value="STG"/>
                                        ...
                                        <div class="col s12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col s6">
                                                    ...
                                                    <p>
                                                        <input name="tp_akhir" type="radio" id="YA16" value="YA"/>
                                                        <label for="YA16">Ya</label>
                                                    </p>
                                                    <p>
                                                        <input name="tp_akhir" type="radio" id="TIDAK16" value="TIDAK"/>
