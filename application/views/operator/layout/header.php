        ...
        <div class="navbar-fixed">
            <nav class="navbar-color fixed   light-blue accent-2" role="navigation">
                <div class="nav-wrapper container">
                    <a href="<?php echo site_url('operator');?>" class="center"><img class="head-atas white-text hoverable" src="<?php echo base_url()?>template/images/logo/kemsos.png"></a>
                    <ul class="right">
                        <li>
                            <a class="btn-floating gradient-45deg-light-blue-cyan white-text  btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Keluar dari sistem" href="<?php echo base_url()?>operator/logout"><i class="material-icons">exit_to_app</i></a>
