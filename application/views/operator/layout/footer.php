...
<!-- plug -->
    ...
    <script type="text/javascript" src="<?php echo base_url();?>template/js/plugins/chartist-js/chartist.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>template/js/plugins/chartjs/chart-script.js"></script>
